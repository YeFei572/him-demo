...
public class WSServerHandler extends SimpleChannelInboundHandler<WSBaseReqProtoOuterClass.WSBaseReqProto> {
     ...
     * 用户下线
     */
    public static void userOffLine(ChannelHandlerContext ctx) throws IOException {
    ...
    public static void userLogin(ChannelHandlerContext ctx, Long uid, String sid) throws IOException {
        ...
        WSBaseResProtoOuterClass.WSBaseResProto result = WSBaseResProtoOuterClass.WSBaseResProto.newBuilder()
                .setType(WSResTypeConstant.LOGIN_OUT)
                .setMessage(WSMessageResProtoOuterClass.WSMessageResProto.newBuilder().setMsgContent("cccccc").build())
                .setCreateTime(new Date().toString())
                .build();
